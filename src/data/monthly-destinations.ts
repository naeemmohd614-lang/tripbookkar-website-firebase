    ...
    destinations: [
      {
        ...
        hotels: ["Suryagarh Jaisalmer", "Jaisalmer Marriott Resort & Spa", "Hotel Rang Mahal", "Fort Rajwada", "The Gulaal"],
      ...
      },
      {
        ...
        hotels: ["The Source at Sula", "Radisson Blu Hotel & Spa, Nashik", "Ginger Nashik", "Ibis Nashik", "Courtyard by Marriott Nashik"],
      ...
      },
      {
        ...
        hotels: ["Spice Village - CGH Earth", "The Elephant Court", "Cardamom County", "Poetree Sarovar Portico", "Amritara Shalimar Spice Garden"],
  ...
  march: {
    ...
    destinations: [
      ...
      },
      {
        ...
        hotels: ["Hyatt Regency Amritsar", "Taj Swarna Amritsar", "Ramada by Wyndham Amritsar", "Fairfield by Marriott Amritsar", "Holiday Inn Amritsar"],
  ...
  april: {
      ...
      destinations: [
        ...
        },
        {
            ...
            hotels: ["Mayfair Darjeeling", "Windamere Hotel", "Elgin Darjeeling", "Cedar Inn", "Viceroy Hotel"],
        ...
        },
        {
            ...
            hotels: ["The Carlton Kodaikanal", "Sterling Kodai Lake", "Kodai Resort Hotel", "Le Poshe by Sparsa", "Zac's Valley Resort"],
        ...
        },
        {
            ...
            hotels: ["Fortune Park Dalhousie", "Grand View Hotel", "Aamod at Dalhousie", "Indraprastha Resort", "JK Clarks Exotica"],
        ...
        },
        {
            ...
            hotels: ["Mayfair Spa Resort & Casino", "Tashiling Residency Hotel & Spa", "The Elgin Nor-Khill", "Summit Denzong Hotel", "Lemon Tree Hotel, Gangtok"],
  ...
  june: {
    ...
    destinations: [
      ...
      },
      {
        ...
        hotels: ["Hyatt Regency Dharamshala Resort", "Fortune Park Moksha", "Radisson Blu Resort Dharamshala", "Chonor House", "Udechee Huts"],
  ...
  august: {
    ...
    destinations: [
      ...
      },
      {
        ...
        hotels: ["Punnamada Resort", "Lake Palace Resort", "Marari Beach Resort - CGH Earth", "Xandari Pearl", "The World Backwaters"],
      ...
      },
      {
        ...
        hotels: ["The Gateway Hotel Pasumalai", "Heritage Madurai", "Courtyard by Marriott Madurai", "JC Residency", "Fortune Pandiyan Hotel"],
  ...
  september: {
    ...
    destinations: [
      ...
      },
      {
        ...
        hotels: ["Le Meridien Mahabaleshwar", "Evershine Keys Prima Resort", "Brightland Resort & Spa", "Citrus Chambers Mahabaleshwar", "Saj Resort"],
  ...
  october: {
    ...
    destinations: [
      ...
      },
      {
        ...
        hotels: ["Radisson Blu Plaza Hotel Mysore", "Grand Mercure Mysore", "Fortune JP Palace", "The Windflower Resort & Spa", "Royal Orchid Metropole"],
      ...
      },
      {
        ...
        hotels: ["The Azzaro Resorts & Spa", "Radhika Beach Resort", "Sugati Beach Resort", "Hotel Apaar", "Krishna Park Resort"],
