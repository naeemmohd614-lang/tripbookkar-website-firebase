...
import allHotels from '@/data/new-hotels.json';
...
export const monthlyDestinationsData: { [key: string]: MonthData } = {
    ...
    destinations: [
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Royal Village", "Himalayan High, Auli", "The Tattva Resort", "Cliff Top Club", "Blue Poppy Resorts"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => h.cityId === 'jaipur'),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Fog Munnar", "Chandys Windy Woods", "KTDC Tea County", "Parakkat Nature Resort", "Amber Dale Luxury Hotel"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => h.city === 'New Delhi').slice(0, 10),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => h.cityId === 'kutch' || h.cityId === 'bhuj'),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Palais de Mahe - CGH Earth", "La Villa", "The Promenade", "Le Dupleix", "Villa Shanti"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => h.city === 'Udaipur').slice(0, 10),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => h.cityId === 'khajuraho'),
  ...
  february: {
    name: 'February',
    slug: 'february',
    pageImage: { src: 'https://images.unsplash.com/photo-1715785070665-c01b8eecbab1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwzfHxzcHJpbmclMjBmbG93ZXJzJTIwZmVzdGl2YWx8ZW58MHx8fHwxNzYzNzI3NTc2fDA&ixlib=rb-4.1.0&q=80&w=1080', caption: 'spring flowers festival' },
    destinations: [
      {
    ...
    destinations: [
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Nidhivan Sarovar Portico, Vrindavan", "The Radha Ashok", "Hotel Brijwasi Royal", "Krishna Residency", "Anandam Clarks Inn Suites"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Westin Resort & Spa, Himalayas", "The Roseate Ganges", "Aloha on the Ganges", "Taj Rishikesh Resort & Spa, Uttarakhand", "EllBee Ganga View"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Evolve Back, Hampi", "Hyatt Place Hampi", "Hampi's Boulders Resort", "Heritage Resort Hampi", "Kishkinda Heritage Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Ri Kynjai", "Hotel Polo Towers Shillong", "The Eee Cee Hotel", "Cafe Shillong Bed & Breakfast", "Aerodene Cottage"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Vythiri Resort", "Banasura Hill Resort", "The Windflower Resort & Spa", "Pepper Trail", "Vythiri Village Resort"].includes(h.name)),
      ...
      },
       {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Evolve Back, Coorg", "The Tamara Coorg", "Taj Madikeri Resort & Spa", "Coorg Wilderness Resort", "Old Kent Estates"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Hyatt Regency Amritsar", "Taj Swarna Amritsar", "Ramada by Wyndham Amritsar", "Fairfield by Marriott Amritsar", "Holiday Inn Amritsar"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Hotel Tawang Heights", "Vivanta Tawang", "Dondrub Homestay", "Hotel Gakyi Khang Zhang", "Hotel Sambala"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Kinara Beach Resort", "The Beach House", "Vatsalya Resort", "Regency Resort", "MTDC Resort, Velneshwar"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Le Méridien Nagpur", "Radisson Blu Hotel Nagpur", "The Pride Hotel Nagpur", "Tuli Imperial", "Hotel Centre Point"].includes(h.name)),
      ...
      destinations: [
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["The Lalit Grand Palace Srinagar", "Vivanta Dal View, Srinagar", "Four Points by Sheraton Srinagar", "The Orchard Retreat & Spa", "Batra Hotel"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Mayfair Darjeeling", "Windamere Hotel", "Elgin Darjeeling", "Cedar Inn", "Viceroy Hotel"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["The Carlton Kodaikanal", "Sterling Kodai Lake", "Kodai Resort Hotel", "Le Poshe by Sparsa", "Zac's Valley Resort"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Welcomheritage Golf View", "MPT Amaltas, Pachmarhi", "Pachmarhi", "Hotel Highlands", "Rock End Manor"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Taj Savoy Hotel, Ooty", "Sterling Ooty Fern Hill", "Gem Park Ooty", "Fortune Resort Sullivan Court", "Sinclairs Retreat Ooty"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Mayfair Himalayan Spa Resort", "The Elgin Silver Oaks, Kalimpong", "Sinclairs Retreat Kalimpong", "Holumba Haven", "Summit Barsana Resort & Spa"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Fortune Park Dalhousie", "Grand View Hotel", "Aamod at Dalhousie", "Indraprastha Resort", "JK Clarks Exotica"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Mayfair Spa Resort & Casino", "Tashiling Residency Hotel & Spa", "The Elgin Nor-Khill", "Summit Denzong Hotel", "Lemon Tree Hotel, Gangtok"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Evolve Back, Kabini", "The Serai Kabini", "Kaav Safari Lodge", "Red Earth Kabini", "Jungle Lodges & Resorts"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Polo Orchid Resort", "Jiva Resort", "Saimika Resort", "Cherrapunjee Holiday Resort", "Coniferous Resort"].includes(h.name)),
  ...
  may: {
      name: 'May',
      slug: 'may',
      pageImage: { src: 'https://images.unsplash.com/photo-1706999281949-fab404605701?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw5fHxjb29sJTIwbW91bnRhaW4lMjB2YWxsZXl8ZW58MHx8fHwxNzYzODI0MzU3fDA&ixlib=rb-4.1.0&q=80&w=1080', caption: 'cool mountain valley' },
      destinations: [
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["The Oberoi Cecil, Shimla", "Wildflower Hall, An Oberoi Resort, Shimla", "Radisson Jass Shimla", "Clarkes Hotel", "Snow Valley Resorts"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["The Himalayan", "Manuallaya - The Resort Spa in the Himalayas", "Span Resort & Spa", "Baragarh Resort", "Solang Valley Resort"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Hotel Hillock", "Cama Rajputana Club Resort", "Hotel Toppers Corner", "WelcomHeritage Connaught House", "Sterling Mount Abu"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Hotel Deyzor", "Sakya Abode", "Grand Dewachen", "Zostel Spiti", "Spiti Heritage Himalayan Brothers"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Colonel's Resort", "The Sky Village", "Bir High", "Chokling Art House", "Tatva Bir Tents and Hotel"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Raju Bharti's Guest House", "The Himalayan Trout House", "Jibhi Homestead", "Sharda Resort", "For A While"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Fairydale Resort", "Vanvasa Resort", "The Alpine Resort", "Blue Pine Resort", "Samskara & Samsara"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Haritha Hill Resort", "Horsley Hills Holiday Homes", "SS Grand", "Sri Krishna Residency", "AP Tourism Guesthouse"].includes(h.name)),
        ...
        },
        {
            ...
            hotels: (allHotels as Hotel[]).filter(h => ["Hotel Sherpa Chalet", "Goparma Hotel", "Hotel Shovraj", "Teesta Valley Resort", "Local Trekkers' Huts"].includes(h.name)),
    ...
    destinations: [
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Grand Dragon Ladakh", "Stok Palace Heritage", "Ladakh Sarai Resort", "The Zen Ladakh", "Hotel Shambhala"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Saj By The Lake", "MTDC Malshej Ghat", "The Regenta MPS", "Jivdani Resort", "Hotel Girija"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Mayfair Spa Resort & Casino", "The Elgin Mount Pandim, Pelling", "Tashiling Residency Hotel & Spa", "Summit Denzong Hotel", "Lemon Tree Hotel, Gangtok"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Tattva Resort", "Hotel Kuber", "Himalayan Abode", "Blue Poppy Swiss Cottage Camps", "Hotel Bhagat"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Hyatt Regency Dharamshala Resort", "Fortune Park Moksha", "Radisson Blu Resort Dharamshala", "Chonor House", "Udechee Huts"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Bhagavathi Nature Camp", "Upasana Retreat", "The Gateway Chikmagalur", "Jungle Lodges & Resorts", "Local Homestays"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Highwavys Travellers Bungalow", "Cloud Mountain Bungalow", "Manalar Estate Bungalow", "Limited Homestays", "Nearby hotels in Theni"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Hotel Regency", "The Grand Hotel", "Hotel Floria", "David's Hotel", "Aizawl Guest House"].includes(h.name)),
  ...
  july: {
    ...
    destinations: [
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Fariyas Resort Lonavala", "The Machan", "Della Resorts", "Radisson Resort & Spa Lonavala", "Rhythm Lonavala"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Amar Mahal Orchha", "Sheesh Mahal Orchha", "Bundelkhand Riverside", "Hotel Raj Mahal", "The Orchha Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Dodda Mane", "Seethanadi Nature Camp", "Kalinga Centre for Rainforest Ecology", "Limited Homestays", "Nearby hotels in Thirthahalli"].includes(h.name)),
  ...
  august: {
    ...
    destinations: [
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Punnamada Resort", "Lake Palace Resort", "Marari Beach Resort - CGH Earth", "Xandari Pearl", "The World Backwaters"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Gopinivas Grand", "Hotel Seaface", "Sparsa Kanyakumari", "Hotel Tri Sea", "Annai Resorts & Spa"].includes(h.name)),
      ...
      },
      {
      ...
      },
       {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Rainforest Resort", "Niraamaya Retreats Samroha", "Casa Rio Resorts", "Willow Heights", "Magic Land Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Gateway Hotel Pasumalai", "Heritage Madurai", "Courtyard by Marriott Madurai", "JC Residency", "Fortune Pandiyan Hotel"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Hotel Hillock", "Cama Rajputana Club Resort", "WelcomHeritage Connaught House", "Sterling Mount Abu", "Hotel Toppers Corner"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Manas Resort with Petting Zoo", "The Herb Farm", "Rainforest Resort and Spa", "Mystic Valley Spa Resort", "Dew Drops Boutique Retreat"].includes(h.name)),
  ...
  september: {
    name: 'September',
    slug: 'september',
    pageImage: { src: 'https://images.unsplash.com/photo-1639369486683-cbdf35613047?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw4fHxwb3N0LW1vbnNvb24lMjBncmVlbiUyMGhpbGxzfGVufDB8fHx8MTc2MzgyNDM1Nnww&ixlib=rb-4.1.0&q=80&w=1080', caption: 'post-monsoon green hills' },
    destinations: [
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Ziro Valley Resort", "Siiro Resort", "Kite-A-Naki", "Abasa Homestay", "Michi Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Apple Orchard Resort", "Jain Group Hotel Sonam Palgey", "Yarlam, Lachung", "Himalayan Residency", "Magpie Nest"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Le Meridien Mahabaleshwar", "Evershine Keys Prima Resort", "Brightland Resort & Spa", "Citrus Chambers Mahabaleshwar", "Saj Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => h.city === 'Mumbai').slice(0, 10),
      ...
      },
       {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Hadora Haveli", "Bundi Inn", "Dev Niwas", "Kasera Paradise", "The Ummaid Bagh Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Sinclairs Siliguri", "The Riverwood Forest Retreat", "Aranya Jungle Resort", "Resort Murti", "Gorumara Jungle Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Aakar Lords Inn", "Patang Residency", "Hotel Anando", "Shilpi Hill Resort", "Toran Hill Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => h.city === 'Pune').slice(0, 10),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Le Méridien Thimphu", "Taj Tashi", "Terma Linca Resort & Spa", "Druk Hotel", "Hotel Osel"].includes(h.name)),
    ...
    destinations: [
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Oberoi Grand, Kolkata", "Taj Bengal", "ITC Sonar, Kolkata", "Hyatt Regency Kolkata", "The Park Kolkata"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Radisson Blu Plaza Hotel Mysore", "Grand Mercure Mysore", "Fortune JP Palace", "The Windflower Resort & Spa", "Royal Orchid Metropole"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Syna Tiger Resort", "Mahua Kothi, A Taj Safari", "Samode Safari Lodge", "Lemon Tree Wildlife Resort", "Nature Heritage Resort"].includes(h.name)),
      ...
      },
      {
      ...
      },
       {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Umaid Bhawan Palace, Jodhpur", "RAAS Jodhpur", "Taj Hari Mahal Jodhpur", "Ajit Bhawan", "The Ummed Jodhpur Palace"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Azzaro Resorts & Spa", "Radhika Beach Resort", "Sugati Beach Resort", "Hotel Apaar", "Krishna Park Resort"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Naini Retreat, by Leisure Hotels", "Shervani Hilltop", "The Manu Maharani", "Vikram Vintage Inn", "The Pavilion"].includes(h.name)),
    ...
    destinations: [
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["BrijRama Palace, Varanasi", "Taj Ganges, Varanasi", "The Clarks, Varanasi", "Hotel Madin", "Ramada Plaza by Wyndham JHV Varanasi"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Westin Pushkar Resort & Spa", "Ananta Spa & Resorts", "Pratap Mahal, Ajmer", "The Greenhouse Resort", "Bhanwar Singh Palace"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Sundarban Tiger Camp", "Sunderban Jungle Mahal", "Royal Bengal Resort", "Solitary Nook", "WBTD Sajnekhali Tourist Lodge"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Royal Residency", "Maha Bodhi Hotel Resort", "Oaks Bodhgaya", "Hotel Bodh Vilas", "Hotel Sujata"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Fern Gir Forest Resort", "Woods at Sasan", "The Gateway Hotel Gir Forest", "Amidhara Resort", "Gir Serai - IHCL SeleQtions"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["The Kumaon", "Gohil's Homestay", "Imperial Heights", "Kasar Rainbow Resort", "Mohan's Binsar Retreat"].includes(h.name)),
  ...
  december: {
    ...
    destinations: [
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["SwaSwara - CGH Earth", "Kahani Paradise", "Kudle Beach View Resort", "Namaste Yoga Farm", "Zostel Gokarna"].includes(h.name)),
      ...
      },
      {
        ...
        hotels: (allHotels as Hotel[]).filter(h => ["Lotus Eco Resort", "Toshali Sands", "The Chariot Resort & Spa", "Mayfair Heritage", "Pramod Convention & Beach Resort"].includes(h.name)),
