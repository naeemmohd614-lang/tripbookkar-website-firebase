    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      {/* Services Section */}
        <section id="services" className="relative py-16 md:py-24">
            <div className="absolute inset-0 z-0 bg-secondary/80">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-headline font-bold drop-shadow-lg text-brand-blue">Hamari Services</h2>
                    <p className="mt-2 text-lg text-muted-foreground drop-shadow-lg">
                        Aapki har zaroorat ke liye, ek perfect solution.
                    </p>
                </div>
        ...
        <div className="container mx-auto px-4 relative z-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
                ...
                <p className="text-gray-300">Apni destination aur dates daalein.</p>
            </div>
            <div className="text-center">
                ...
                <p className="text-gray-300">Apni pasand ka hotel select karein.</p>
            </div>
            <div className="text-center">
                ...
                <p className="text-gray-300">Hamein call karein ya quote request karein.</p>
            </div>
             <div className="text-center">
                ...
                <p className="text-gray-300">Best price par booking confirm karein.</p>
            </div>
          </div>
