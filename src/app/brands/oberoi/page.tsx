...
export default function OberoiPage() {
    ...
    const oberoiHotelsQuery = useMemoFirebase(() => firestore ? query(collection(firestore, 'hotels'), where('brand', 'in', oberoiBrandNames)) : null, [firestore]);
    ...
    return (
        <div className="bg-background text-foreground">
            ...
            <section id="preferred-properties" className="py-16">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl font-headline font-bold text-primary mb-4">
                        Our Preferred Oberoi Properties
                    </h2>
                    <p className="max-w-2xl mx-auto text-muted-foreground mb-8">
                       Experience award-winning service and luxury that is heartfelt, not just measured.
                    </p>
            ...
            <section id="all-oberoi-hotels" className="py-16 bg-secondary/30">
