    ...
    const jnkCities = ['Srinagar', 'Gulmarg', 'Pahalgam'].map(cityName => {
      ...
      const cityId = city ? city.cityId : slugify(cityName);
       const cityImages: { [key: string]: { image: string, caption: string } } = {
        ...
        'gulmarg': { image: 'https://images.unsplash.com/photo-1593361589133-c82a55982855?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxndWxtYXJnJTIwc2tpaW5nfGVufDB8fHx8fDE3NjM4MDA2NTV8MA&ixlib=rb-4.1.0&q=80&w=1080', caption: 'gulmarg city' },
